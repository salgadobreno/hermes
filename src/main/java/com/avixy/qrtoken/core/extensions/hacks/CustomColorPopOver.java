package com.avixy.qrtoken.core.extensions.hacks;
 ...
 * @author paru
 */
public class CustomColorPopOver extends HBox {
    ...
    public CustomColorPopOver(Control control) {
        this.owner = control;
    ...
    private class ColorRectPane extends HBox {
        ...
        private void updateRGBColor() {
            Color newColor = Color.rgb(red.get(), green.get(), blue.get(), 1);
...
//                    clamp(alpha.get()/100)));
    ...
    private class ControlsPane extends VBox {
        ...
        public ControlsPane() {
            ...
            hBox.getChildren().addAll(rgbButton);
