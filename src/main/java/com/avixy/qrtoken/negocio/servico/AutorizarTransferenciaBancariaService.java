 ...
 */
public class AutorizarTransferenciaBancariaService extends EncryptedTemplateMessageService {
    List<Param> paramsBuffer = new ArrayList<>();

    @Inject
    public AutorizarTransferenciaBancariaService(AesKeyPolicy keyPolicy) {
        super(keyPolicy);
    }
