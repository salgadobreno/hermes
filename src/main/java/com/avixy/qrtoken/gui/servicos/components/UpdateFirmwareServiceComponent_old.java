...
//public class UpdateFirmwareServiceComponent_old extends ServiceComponent {
...
//
//    @Inject
//    protected UpdateFirmwareServiceComponent_old(final UpdateFirmwareService service) {
//        super(service);
